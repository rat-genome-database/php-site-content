...
function curation_selectTerms() {
	...
	$toReturn = '    <script src="/rgdweb/js/jquery/jquery-1.7.1.min.js"></script>
...
function getAnnotationsHTMLTableByGenes($objectRGDIDArray, $ontTerms, $referenceArray) {
	...
	$sql = 'select 1 as score, a.FULL_ANNOT_KEY, a.TERM, a.ANNOTATED_OBJECT_RGD_ID, a.DATA_SRC, a.OBJECT_SYMBOL, a.REF_RGD_ID, a.EVIDENCE, a.WITH_INFO, a.ASPECT, a.OBJECT_NAME, a.QUALIFIER, a.RELATIVE_TO, a.CREATED_DATE, a.LAST_MODIFIED_DATE, a.EXP_RGD_ID, a.TERM_ACC, a.CREATED_BY, a.LAST_MODIFIED_BY, a.XREF_SOURCE, to_char(a.notes) as notes, r.species_type_key from full_annot a, rgd_ids r ';
...
//	$sql .= '  order by object_symbol, EVIDENCE, term ';
	if ($refIds != '') {
		$refSql = 'select 2 as score, a.FULL_ANNOT_KEY, a.TERM, a.ANNOTATED_OBJECT_RGD_ID, a.DATA_SRC, a.OBJECT_SYMBOL, a.REF_RGD_ID, a.EVIDENCE, a.WITH_INFO, a.ASPECT, a.OBJECT_NAME, a.QUALIFIER, a.RELATIVE_TO, a.CREATED_DATE, a.LAST_MODIFIED_DATE, a.EXP_RGD_ID, a.TERM_ACC, a.CREATED_BY, a.LAST_MODIFIED_BY, a.XREF_SOURCE, to_char(a.notes) as notes, r.species_type_key from full_annot a, rgd_ids r ';
	...
	if ($termAcc != '') {
		$termSql = 'select 4 as score, a.FULL_ANNOT_KEY, a.TERM, a.ANNOTATED_OBJECT_RGD_ID, a.DATA_SRC, a.OBJECT_SYMBOL, a.REF_RGD_ID, a.EVIDENCE, a.WITH_INFO, a.ASPECT, a.OBJECT_NAME, a.QUALIFIER, a.RELATIVE_TO, a.CREATED_DATE, a.LAST_MODIFIED_DATE, a.EXP_RGD_ID, a.TERM_ACC, a.CREATED_BY, a.LAST_MODIFIED_BY, a.XREF_SOURCE, to_char(a.notes) as notes,	 r.species_type_key from full_annot a, rgd_ids r ';
		...
		$termSql = 'select 3 as score, a.FULL_ANNOT_KEY, a.TERM, a.ANNOTATED_OBJECT_RGD_ID, a.DATA_SRC, a.OBJECT_SYMBOL, a.REF_RGD_ID, a.EVIDENCE, a.WITH_INFO, a.ASPECT, a.OBJECT_NAME, a.QUALIFIER, a.RELATIVE_TO, a.CREATED_DATE, a.LAST_MODIFIED_DATE, a.EXP_RGD_ID, a.TERM_ACC, a.CREATED_BY, a.LAST_MODIFIED_BY, a.XREF_SOURCE, to_char(a.notes) as notes,	 r.species_type_key from full_annot a, rgd_ids r ';
		$termSql .= '  WHERE a.data_src NOT IN(\'CTD\',\'ClinVar\') AND ';
		$termSql .= '  ANNOTATED_OBJECT_RGD_ID in ( ' . $objIds;
		$termSql .= ' ) and a.ANNOTATED_OBJECT_RGD_ID = r.RGD_ID ';
